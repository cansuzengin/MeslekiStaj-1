...
namespace MvcProject.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> BugunVerilenOduncKitap()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("BugunVerilenOduncKitap");
        }
