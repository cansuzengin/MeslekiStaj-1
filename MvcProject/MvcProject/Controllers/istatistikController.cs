...
namespace MvcProject.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult LinqKart()
        {
            ...
            var deger9 = db.TBLKITAP.GroupBy(x => x.YAYINEVI).OrderByDescending(y => y.Count()).Select(z => z.Key).FirstOrDefault();
            var deger10 = db.EnBasariliPersonel().FirstOrDefault();
            var deger11 = db.TBLILETISIM.Where(x => x.MESAJ != null).Count();
            var deger12 = db.BugunVerilenOduncKitap().FirstOrDefault();
            ViewBag.dgr1 = deger1;
            ViewBag.dgr2 = deger2;
            ViewBag.dgr3 = deger3;
            ViewBag.dgr4 = deger4;
